...
export const signUpZodSchema = z
  .object({
    ...
    bio: z.string().trim().min(5,"Bio must be at least 5 characters").max(160, "Bio must be at most 160 characters").optional(),
  ...
  */
  ...
  export const updateUserZodSchema = z.object({
    ...
    city: z
      ...
      .trim()
      .min(2, "City must be at least 2 characters")
      .max(100, "City name is too long").optional(),

    state: z
      .string()
      .trim()
      .min(2, "State must be at least 2 characters")
      .max(100, "State name is too long").optional(),

    country: z
      .string()
      .trim()
      .min(2, "Country must be at least 2 characters")
      .max(100, "Country name is too long").optional(),

    pinCode: z
      .string()
      .trim()
      .regex(/^[0-9]{6}$/, "Pin code must be exactly 6 digits").optional(),
    bio: z
      .string()
      .trim()
